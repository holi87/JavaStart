...
public class Ksiazka {
	...
	// konstruktory
	public Ksiazka(String ksiazkaTytul, String ksiazkaAutor, int ksiazkaDataWydania, int ksiazkaIloscStron, String ksiazkaWydawca, String ksiazkaISBN){
	...
	public Ksiazka(Ksiazka ksiazka){
		this(ksiazka.getTytul(), ksiazka.getAutor(), ksiazka.getDataWydania(), ksiazka.getIloscStron(), ksiazka.getWydawca(), ksiazka.getISBN());
	}
	
	
	// wyswietlenie
	public void printInfo(){
		String info = getTytul() + "; " + getAutor() + "; " + getDataWydania() + "; " + getIloscStron() + "; " + getWydawca() + "; " + getISBN();
